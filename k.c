...
void *ThrA(){
    struct sched_param *ft1 = malloc(sizeof(struct sched_param));
    ...
    double val = (end.tv_sec - ini.tv_sec ) ;
    printf("For SCHED_OTHER part: ");
    printf("%lf",val);
    printf("\n");
}
void *ThrB(){
    struct sched_param *ft2 = malloc(sizeof(struct sched_param));
    ft2->sched_priority = 0;
    ...
    double val1 = end1.tv_sec - ini1.tv_sec ;
...
void *ThrC(){
    ...
    double val2 = end2.tv_sec - ini2.tv_sec ;
